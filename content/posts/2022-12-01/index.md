...
- [generic tuning interface](#generic-tuning-interface)
- [naturals package](#naturals-package)
- [octaves package](#octaves-package)
- [Adapted notes to make use of naturals and octaves](#adapted-notes-to-make-use-of-naturals-and-octaves)
- [Introduced Note.MIDI](#introduced-notemidi)
...
- [Closing the gap with MIDI](#closing-the-gap-with-midi)
- [Lots of internal refactor](#lots-of-internal-refactor)
- [Initial attempt at muffear, MIDI-to-earmuff converter](#initial-attempt-at-muffear-midi-to-earmuff-converter)
- [A demo ?](#a-demo)
- [ChatGPT](#chatgpt)
