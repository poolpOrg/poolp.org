...
--
As usual,
a **huge** thanks goes to the people sponsoring me on [patreon](https://www.patreon.com/gilles) or [github](https://github.com/sponsors/poolpOrg).

In February,
I switched to a 75% part-time schedule so that I could spend **one week each month** working on my own stuff,
mostly opensource,
at the cost of **slashing a quarter of my wage**.
I'll spend most of these weeks on opensource and writing articles,
but I might also have to take some contracts and sponsored developments to cover my expenses.
I opened a [patreon](https://www.patreon.com/gilles) and registered to the [github sponsoring program](https://github.com/sponsors/poolpOrg),
so if enough people find enough value in my work and sponsor it,
I can spend more time publishing stuff for the community.
...
it'll essentially double your contribution.

If you know of companies that could make use of my skills **<font color="red">on short missions as a freelance consultant or system developer</font>**,
don't hesitate to point them at me or contact me in private,
I could use some contracts right now ;-)

All of the work described in this blog post happened during my spare time,
so thanks to the people who make this possible !
...
---- 
Comments: [https://github.com/poolpOrg/poolp.org_posts/issues/26](https://github.com/poolpOrg/poolp.org_posts/issues/26)
