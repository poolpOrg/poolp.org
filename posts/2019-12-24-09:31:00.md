...
--
This month,
I have written an article regarding my work on "[SPF-aware greylisting and filter-greylist](https://poolp.org/posts/2019-12-01/spf-aware-greylisting-and-filter-greylist/)".

In addition,
I have reworked my "[Setting up a mail server with OpenSMTPD, Dovecot and Rspamd](https://poolp.org/posts/2019-09-14/setting-up-a-mail-server-with-opensmtpd-dovecot-and-rspamd/)" article and removed the political aspect of it to make it a standalone article,
"[Decentralised SMTP is for the greater good](http://localhost:1313/posts/2019-12-15/decentralised-smtp-is-for-the-greater-good/)".
Both of them were translated in French,
"[Mettre en place un serveur de mail avec OpenSMTPD, Dovecot et Rspamd](http://localhost:1313/posts/2019-12-23/mettre-en-place-un-serveur-de-mail-avec-opensmtpd-dovecot-et-rspamd/)" and
"[Decentralisons SMTP pour le bien commun](http://localhost:1313/posts/2019-12-15/decentralisons-smtp-pour-le-bien-commun/)".
